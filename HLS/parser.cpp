...
parser::basic_block::basic_block(std::string &label)
{
    _label = label;
}

void parser::basic_block::add_statement(statement &s)
{
    _statements.push_back(s);
}

parser::parser::parser(const std::string &filename)
    : _filename(filename)
{
}
...
int parser::parser::parse_function(std::string &line)
{
    char *tok;
    std::string key;
    char sep[] = " (,)";
...
void parser::basic_block::clear_statements()
{
    _statements.clear();
}

int parser::parser::parse_statement(std::string &line, basic_block &bb)
{
    char *tok;
    std::string key;
    char sep[] = " (,);";
